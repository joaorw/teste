...
public class UC01RegistraEmprestimoDeLivro {
	...
	public void CT07QuandoUsuarioNuloErro() {
        ...
        @Test
        public void CT08QuandoAdataDeEmprestimoForInvalidadaErro() {
        	//cenario
        ...
        @Test
        public void CT09QuandoAdataDeEmprestimoForInvalidadaErro() {
        	//cenario
        ...
        @Test
        public void CT10QuandoAdataDeEmprestimoForInvalidadaErro() {
        	//cenario
        	String data= "09/05/2018";
        	Emprestimo umEmprestimo = new Emprestimo();
        	//acao
